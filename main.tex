...
The model predictions from both models for the $J/\psi$ production with a \SI{120}{\GeV}
...
$\sigma^{pd}/2\sigma^{pp}$ ratios. While the measured Drell-Yan ratio \cite{dove2021}
